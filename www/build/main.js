...
var ProfilePage = /** @class */ (function () {
    ...
    ProfilePage.prototype.shareViaWhatsApp = function () {
        var _this = this;
        this.platform.ready().then(function () {
            ...
            _this.screenshot.URI(100)
                ...
                _this.socialSharing.shareViaWhatsApp('test', res.URI, 'test');
            }, function (err) {
            });
        });
    };
