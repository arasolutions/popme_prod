...
var ClanProfilePage = /** @class */ (function () {
    ...
    ClanProfilePage.prototype.sharePassword = function (name, password) {
        var _this = this;
        this.platform.ready().then(function () {
            ...
            _this.screenshot.URI(100)
                .then(function (res) {
                var options = {
                    message: 'Rejoins mon clan ' + name + ' avec le mot de passe : ' + password + '. Rendez-vous sur Popme !',
                    subject: '',
                    files: '',
                    url: 'test',
