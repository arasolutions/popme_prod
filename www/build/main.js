    ...
    ProfilePage.prototype.shareViaSMS = function () {
        ...
        this.platform.ready().then(function () {
            ...
            _this.screenshot.URI(100)
                .then(function (res) {
                var options = {
                    message: 'Regarde mon profil Popme sur popme://loading',
                    subject: '',
                    files: [res.URI],
                    url: '',
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__pages_pages__ = __webpack_require__(137);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var MyApp = /** @class */ (function () {
    function MyApp(platform, statusBar, splashScreen, keyboard, deeplinks) {
        var _this = this;
        this.rootPage = __WEBPACK_IMPORTED_MODULE_6__pages_pages__["b" /* LoadingPage */];
        platform.ready().then(function () {
            ...
            deeplinks.routeWithNavController(_this.navChild, {
                '/loading': __WEBPACK_IMPORTED_MODULE_6__pages_pages__["b" /* LoadingPage */]
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__poperprofile_poperprofile_module__ = __webpack_require__(366);
