...
var LoadingPage = /** @class */ (function () {
    function LoadingPage(navCtrl, navParams, viewCtrl, imagePicker, app, api, storage, alertCtrl, camera, actionSheetCtrl, loadingCtrl, users, storageProvider, gameProvider, rankProvider, ga, platform, translate) {
        ...
        this.api.setLang(this.translate.getDefaultLang());
    }
...
var SettingsPage = /** @class */ (function () {
    ...
    SettingsPage = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["k" /* NavController */],
            ...
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["a" /* ActionSheetController */],
            __WEBPACK_IMPORTED_MODULE_7__ionic_native_camera__["a" /* Camera */],
            __WEBPACK_IMPORTED_MODULE_4__providers_providers__["k" /* Users */],
            __WEBPACK_IMPORTED_MODULE_8__ngx_translate_core__["c" /* TranslateService */]])
    ], SettingsPage);
    return SettingsPage;
}());
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_users_users__ = __webpack_require__(70);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__poperprofile_poperprofile__ = __webpack_require__(71);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__ionic_storage__ = __webpack_require__(10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__rank_relativeRank__ = __webpack_require__(173);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__ionic_native_photo_viewer__ = __webpack_require__(89);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__pages__ = __webpack_require__(38);
...
var TrendPage = /** @class */ (function () {
    function TrendPage(navCtrl, navParams, loadingCtrl, api, modalCtrl, storage, platform, photoViewer, translate, userProvider) {
        var _this = this;
        this.navCtrl = navCtrl;
        this.navParams = navParams;
        this.loadingCtrl = loadingCtrl;
    ...
    TrendPage.prototype.prepareModalRanking = function (type) {
        var profileModal = this.modalCtrl.create(__WEBPACK_IMPORTED_MODULE_7__rank_relativeRank__["a" /* RelativeRankPage */], { userProfile: type });
        profileModal.present();
    };
    TrendPage.prototype.ionViewDidLoad = function () {
    };
    TrendPage.prototype.pushToProfile = function () {
        this.navCtrl.push(__WEBPACK_IMPORTED_MODULE_9__pages__["n" /* ProfilePage */], {}, { animate: true, direction: 'back' });
    };
    TrendPage.prototype.pushToPlay = function () {
        this.navCtrl.push(__WEBPACK_IMPORTED_MODULE_9__pages__["i" /* PlayPage */], {}, { animate: true, direction: 'back' });
    };
    TrendPage.prototype.pushToLog = function () {
        this.navCtrl.push(__WEBPACK_IMPORTED_MODULE_9__pages__["f" /* LogPage */], {}, { animate: true, direction: 'back' });
    };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__ionic_storage__ = __webpack_require__(10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__translate_translate__ = __webpack_require__(821);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var Api = /** @class */ (function () {
    ...
    Api.prototype.setLang = function (lang) {
        this.lang = lang;
    };
    Api = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Injectable"])(),
        __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1__angular_http__["a" /* Http */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__angular_http__["a" /* Http */]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_3__ionic_storage__["b" /* Storage */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_3__ionic_storage__["b" /* Storage */]) === "function" && _b || Object, typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_4__translate_translate__["a" /* Translate */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_4__translate_translate__["a" /* Translate */]) === "function" && _c || Object])
    ], Api);
    return Api;
    var _a, _b, _c;
}());
...
var ProfilePage = /** @class */ (function () {
    ...
    ProfilePage.prototype.viewImg = function (index, nbPops) {
        if (this.user.popies[index].image) {
            this.photoViewer.show(this.user.popies[index].image, this.user.popies[index].pop_count + ' pops recus', { share: true });
        }
    };
            ...
            _this.platform.ready().then(function () {
                ...
                _this.screenshot.URI(100)
                    ...
                    var options = {
                        ...
                        subject: '',
                        files: [body],
                        url: 'https://www.popme.app/loading',
...
var Translate = /** @class */ (function () {
    function Translate(translate, storage) {
        this.translate = translate;
        this.storage = storage;
    ...
    Translate = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Injectable"])(),
        __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1__ngx_translate_core__["c" /* TranslateService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__ngx_translate_core__["c" /* TranslateService */]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_2__ionic_storage__["b" /* Storage */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__ionic_storage__["b" /* Storage */]) === "function" && _b || Object])
    ], Translate);
    return Translate;
    var _a, _b;
}());
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__providers_providers__ = __webpack_require__(18);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
