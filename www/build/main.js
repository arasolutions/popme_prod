...
var ClanChatPage = /** @class */ (function () {
    ...
    ClanChatPage.prototype.scrollBottom = function () {
        ...
        //alert(this.content.scrollHeight + ' - ' + this.content.contentHeight + ' - ' + this.content.contentBottom);
    };
...
var Clan = /** @class */ (function () {
    ...
    Clan.prototype.setCurrentClan = function (clan) {
        ...
        this.chat = clan.chat;
        for (var chat in this.chat) {
            if (this.chat[chat].type == 'image') {
                var imageChat = new Image();
                imageChat.src = this.chat[chat].text;
            }
        }
        this.date = new Date();
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__firstStep_firstStep1_module__ = __webpack_require__(402);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__rank_relativeRank_module__ = __webpack_require__(419);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__autoComplete_autoComplete_module__ = __webpack_require__(391);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_23__preview_preview_module__ = __webpack_require__(412);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_24__tutoriel_tutoriel_profile_step1_module__ = __webpack_require__(422);
